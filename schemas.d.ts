...
export interface AdminUser extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    isActive: BooleanAttribute &
      PrivateAttribute &
      DefaultTo<false>;
    roles: RelationAttribute<
      'admin::user',
      'manyToMany',
      'admin::role'
    > &
      PrivateAttribute;
    blocked: BooleanAttribute &
      PrivateAttribute &
      DefaultTo<false>;
...
export interface ApiCheapFlightsToDestinationCheapFlightsToDestination
  extends CollectionTypeSchema {
  info: {
    singularName: 'cheap-flights-to-destination';
    pluralName: 'cheap-flights-to-destinations';
    displayName: 'Cheap-Flights-To-Destination';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    DealsDescription: RichTextAttribute &
      SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare global {
  namespace Strapi {
    interface Schemas {
      ...
      'api::cheap-flights-to-destination.cheap-flights-to-destination': ApiCheapFlightsToDestinationCheapFlightsToDestination;
